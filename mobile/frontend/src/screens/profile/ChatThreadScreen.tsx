...
import { ChatStackParamList, HomeStackParamList, SearchStackParamList } from '../../navigation/types';

type Props = NativeStackScreenProps<ChatStackParamList | HomeStackParamList | SearchStackParamList, 'ChatThread'>;
